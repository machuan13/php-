            ...
            <fieldset class="form">
                <p>
                    <label class="loginlabel" for="user_name">
                        Username:</label>
                    <input class="logininput ui-keyboard-input ui-widget-content ui-corner-all" name="uid"
                           id="uid" type="text" value="" />
                </p>
                <p>
                    <label class="loginlabel" for="pwd">
                        Password:</label>
                    <span>
                        <input class="logininput"   name="pwd" id="pwd" type="password" /><img
                                id="pwd" class="tooltip" alt="Click to open the virtual keyboard" title="Click to open the virtual keyboard"
